...
Задание № 13 - в alembic/env.py добавить путь к src и метаданным:
...
# Pydantic-схемы
'''
Задание № 15 - создать пустой файл src/schemas/__init__.py
...
'''
Задание № 18 - модифицировать файл src/main.py
...
СОВЕТ ПРЕПОДАВАТЕЛЮ: при добавлении новой функции запускайте процесс тестирования через python -m pytest,
